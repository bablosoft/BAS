<span id="action-add">
  <div class="container-fluid">
      ...
      <div class="container-fluid">
        <div class="tooltipinternal tr">Using resources is the best way to select record.</div>
      </div>
  ...
  <div style="margin-top:10px">
    <%= _.template($('#input_constructor').html())({id:"PageNumber", description:tr("Page number"), default_selector: "int", disable_string:true, value_number: 1}) %>
    <%= _.template($('#input_constructor').html())({id:"PageSize", description:tr("Page size"), default_selector: "int", disable_string:true, value_number: 1000}) %>

    <%= _.template($('#variable_constructor').html())({id:"RecordList", description:tr("Record list"), default_variable: "RECORD_LIST"}) %>
  </div>
