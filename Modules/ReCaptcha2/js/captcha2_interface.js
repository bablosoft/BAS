<div class="container-fluid captcha2">
  <%= _.template($('#input_constructor').html())({id:"TimesToSolve", description:tr("How many times try to solve"), default_selector: "int", disable_string:true, value_number: 5, size: 3}) %>
  <%= _.template($('#input_constructor').html())({id:"Method", description:tr("Solve Method"), default_selector: "string", disable_int:true, value_string: "manual", variants: ["manual","rucaptcha","2captcha","antigate","capmonsterimage","capmonsteraudio","dbc"], size: 3}) %>
