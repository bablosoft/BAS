<div class="container-fluid captcha2">
  ...
  <%= _.template($('#input_constructor').html())({id:"Method", description:tr("Solve Method"), default_selector: "string", disable_int:true, value_string: "manual", variants: ["manual","rucaptcha","2captcha","antigate","capmonsterimage","capmonsteraudio","dbc","rucaptcha-newapi","2captcha-newapi"], size: 3}) %>
